...
RUN wget http://lilypond.org/download/binaries/linux-64/lilypond-2.22.1-1.linux-64.sh
RUN chmod +x lilypond-2.22.1-1.linux-64.sh
RUN ./lilypond-2.22.1-1.linux-64.sh
